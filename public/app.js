...
function answerDetail(a, rubric, keyPoints) {
  ...
  const wrongNote = a.wrong && !a.flag && !a.skipped ? `<p class="small muted" style="margin-bottom:8px">This answer was judged mostly off target, so it scored 0 even where a key fact partly matched.</p>` : "";
  const flagNote = wrongNote + (a.flag === "abuse" ? `<p class="small muted" style="margin-bottom:8px">This answer was hidden from other players for its language.</p>` : a.flag === "injection" ? `<p class="small muted" style="margin-bottom:8px">This answer talked to the scorer instead of answering, so it scored 0.</p>` : "");
